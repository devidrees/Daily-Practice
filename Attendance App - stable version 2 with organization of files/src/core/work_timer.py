...
class WorkTimer:
    ...
    def configure_styles(self):
        ...
        style.configure('Menu.TFrame', background='#343a40')  # Dark background for menu
        
        # Configure menu buttons style with white text
        style.configure('Menu.TButton', 
                       font=('Arial', 14, 'bold'),
                       padding=(10, 5),
                       background='#343a40',
                       foreground='white')  # White text for menu buttons
        ...
        style.map("Green.TButton",
                 background=[('disabled', '#808080'), ('active', '#218838')],
        ...
        style.map("Red.TButton",
                 background=[('disabled', '#808080'), ('active', '#c82333')],
                 foreground=[('disabled', 'white'), ('active', 'white')])
        ...
        style.map("Blue.TButton",
                 background=[('disabled', '#808080'), ('active', '#0056b3')],
                 foreground=[('disabled', 'white'), ('active', 'white')])
        ...
        # Configure window control buttons with white text
        ...
        style.map("WindowControl.TButton",
                 background=[('disabled', '#343a40'), ('active', '#4a4a4a')],
                 foreground=[('disabled', '#808080'), ('active', 'white')])
        ...
        # Configure timer label style
        style.configure('Timer.TLabel',
                       font=('Arial', 64, 'bold'),
                       background='#f0f5ff',
                       foreground='#000000')  # Black text for main window
        
        style.configure('FloatingTimer.TLabel',
                       font=('Arial', 24, 'bold'),
                       background='#343a40',
                       foreground='white')  # White text for floating window
        ...
        style.configure('SidebarClose.TButton',
                       font=('Arial', 10),
                       padding=(5, 5))
        style.map("SidebarClose.TButton",
                 background=[('active', '#f8f9fa')],
                 foreground=[('disabled', '#808080')])
    ...
    def create_floating_window(self):
        ...
        # Window control buttons with white text
        ttk.Button(
            controls_frame,
            text="−",
            width=2,
        ...
        # Timer content with dark background
        content_frame = ttk.Frame(main_frame, style='Floating.TFrame', padding=10)
        content_frame.pack(fill=tk.BOTH, expand=True)
        
        # Timer display with white text
        self.floating_timer_label = ttk.Label(
            content_frame,
            text="00:00:00",
            style="FloatingTimer.TLabel"
        )
        self.floating_timer_label.pack(pady=5)
        
        # Control buttons
        btn_frame = ttk.Frame(content_frame, style='Floating.TFrame')
        btn_frame.pack(pady=5)
        
        # Start button with white text
